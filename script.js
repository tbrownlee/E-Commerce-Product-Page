...
let iconMenu = document.querySelector('.header__nav__icon-menu');
...
let logo = document.querySelector('.header__nav__logo');
...
let navIconClose = document.querySelector('.header__nav__ul__icon-close');
